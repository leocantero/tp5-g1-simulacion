...
## 12. Anexo: archivos del proyecto

| Archivo | Contenido |
|---------|-----------|
| `analisis_y_fdps.py` | Análisis del dataset y ajuste de las 9 FDPs con Fitter |
| `simulacion.py` | Implementación del modelo evento-a-evento, ejecutable por CLI |
| `evaluacion_sla.py` | Evaluación de configuraciones bajo el criterio SLA (TF = 88.000 min) |
| `diagrama_flujo.md` | Diagrama de flujo y glosario del modelo |
